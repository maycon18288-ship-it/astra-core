...
import astra.core.api.npclib.api.event.*;
import astra.core.menus.shop.PrincipalShopMenu;
...
import astra.core.api.npclib.npc.skin.SkinUpdateTracker;
...
public class NPCListeners implements Listener {
  ...
  public void onNPCRightClick(NPCRightClickEvent evt) {
    ...
    if (profile != null) {
      NPC npc = evt.getNPC();
      if (npc.data().has("shop-npc")) {
        new PrincipalShopMenu(profile);
      }
    }
  }
