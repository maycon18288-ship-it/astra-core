...
public class AuroraLogger extends PluginLogger {

  private final Plugin plugin;
  private final String prefix;
  private final CommandSender sender;

  public AuroraLogger(Plugin plugin) {
    super(plugin);
    this.plugin = plugin;
  ...
  public AuroraLogger(AuroraLogger parent, String prefix) {
    super(parent.plugin);
  ...
  public AuroraLogger getModule(String module) {
    return new AuroraLogger(this, module + ": ");
  }
