...
import astra.core.nms.v1_8_R3.NMS1_8R3;
...
public class NMS {
  ...
  public static final AuroraLogger LOGGER = ((AuroraLogger) Core.getInstance().getLogger()).getModule("NMS");
