package astra.core.nms.v1_8_R3;

import astra.core.nms.v1_8_R3.entity.*;
import astra.core.nms.v1_8_R3.entity.EntityArmorStand;
import astra.core.nms.v1_8_R3.entity.EntityItem;
import astra.core.nms.v1_8_R3.entity.EntitySlime;
import astra.core.nms.v1_8_R3.entity.*;
...
import astra.core.nms.interfaces.INMS;
...
import astra.core.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import astra.core.nms.v1_8_R3.utils.UUIDMetadataStore;
import astra.core.reflection.Accessors;
import astra.core.reflection.acessors.FieldAccessor;
import astra.core.utils.Utils;
...
public class NMS1_8R3 implements INMS {
  ...
  private final FieldAccessor<Set> SET_TRACKERS;
    ...
    public NMS1_8R3() {
      FieldAccessor<Map> CLASS_TO_ID = Accessors.getField(EntityTypes.class, "f", Map.class);
      FieldAccessor<Map> CLASS_TO_NAME = Accessors.getField(EntityTypes.class, "d", Map.class);
    ...
    CLASS_TO_NAME.get(null).put(EntityArmorStand.class, "aCore-ArmorStand");
