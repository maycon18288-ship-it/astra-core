package astra.core.nms.v1_8_R3.utils;

import net.minecraft.server.v1_8_R3.*;
import astra.core.nms.v1_8_R3.entity.EntityNPCPlayer;
import astra.core.nms.v1_8_R3.utils.pathfinding.PlayerPathfinder;
import astra.core.nms.v1_8_R3.utils.pathfinding.PlayerPathfinderNormal;
...
public class PlayerNavigation extends NavigationAbstract {
  ...
  protected boolean a(Vec3D paramVec3D1, Vec3D paramVec3D2, int paramInt1, int paramInt2, int paramInt3) {
    ...
    double d7 = i - paramVec3D1.a;
    double d8 = j - paramVec3D1.c;
    if (d1 >= 0.0D) {
      d7 += 1.0D;
    }
    if (d2 >= 0.0D) {
