package astra.core.nms.v1_8_R3.entity;
...
import astra.core.api.npclib.npc.skin.SkinPacketTracker;
import astra.core.api.npclib.npc.skin.SkinnableEntity;
import astra.core.nms.NMS;
import astra.core.nms.v1_8_R3.network.EmptyNetHandler;
import astra.core.nms.v1_8_R3.utils.PlayerNavigation;
import astra.core.nms.v1_8_R3.utils.controllers.PlayerControllerJump;
import astra.core.nms.v1_8_R3.utils.controllers.PlayerControllerLook;
import astra.core.nms.v1_8_R3.utils.controllers.PlayerControllerMove;
...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder, SkinnableEntity {
  ...
  static class PlayerNPC extends CraftPlayer implements NPCHolder, SkinnableEntity {
    ...
    @Override
    public SkinPacketTracker getSkinTracker() {
      return ((EntityNPCPlayer) entity).getSkinTracker();
    }
    ...
    @Override
    public void setSkin(Skin skin) {
      ((EntityNPCPlayer) entity).setSkin(skin);
    }

    @Override
    public Skin getNpcSkin() {
      return ((EntityNPCPlayer) entity).getNpcSkin();
    }

    @Override
    public void setSkinFlags(byte flags) {
      ((EntityNPCPlayer) entity).setSkinFlags(flags);
    }
  }
}
